...
const TRADUCTIONS_SERVEUR = {
  fr: {
    ...
    sheets: {
      ...
      nomJournal: 'Journal des dérogations',
      entetesJournal: ['Horodatage', 'Action', 'ID CIS', 'Auteur', 'Détail'],
      ...
      couverture: 'COUVERTURE DE L\'AUDIT',
      superAdminsRecenses: 'Super administrateurs recensés',
      exhaustif: 'recensement exhaustif (requête ciblée isAdmin=true)',
      parDeduction: 'déduits de la liste plafonnée — possiblement incomplet',
      utilisateursAnalyses: 'Utilisateurs analysés',
      groupesAnalyses: 'Groupes analysés',
      unitesRecensees: 'Unités organisationnelles recensées',
      plafondAtteint: ' — PLAFOND ATTEINT, échantillon tronqué',
      unitesNonCollectees: 'non collectées — héritage des politiques indéterminé',
      aucunJournal: 'Aucun mouvement enregistré.',
  ...
  en: {
    ...
    sheets: {
      ...
      nomJournal: 'Deviation Audit Log',
      entetesJournal: ['Timestamp', 'Action', 'CIS ID', 'Author', 'Details'],
      ...
      couverture: 'AUDIT COVERAGE',
      superAdminsRecenses: 'Super administrators found',
      exhaustif: 'exhaustive (targeted isAdmin=true query)',
      parDeduction: 'derived from the capped user list — possibly incomplete',
      utilisateursAnalyses: 'Users analysed',
      groupesAnalyses: 'Groups analysed',
      unitesRecensees: 'Organizational units found',
      plafondAtteint: ' — CAP REACHED, sample truncated',
      unitesNonCollectees: 'not collected — policy inheritance undetermined',
      aucunJournal: 'No recorded activity.',
